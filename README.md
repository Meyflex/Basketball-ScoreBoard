...
1. Clone the repo
   ```sh
   git clone https://github.com/meyflex/Basketball-ScoreBoard.git
   ```
...
Project Link: [https://github.com/Meyflex/Basketball-ScoreBoard](https://github.com/Meyflex/Basketball-ScoreBoard)
